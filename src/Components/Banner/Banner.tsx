      ...
      <div className='banner'>
        <div className="content">
            <div className="left">
                ...
                <Button className='bbtn fa-beat-fade' href='https://t.me/uztaxi_probot' data-aos="fade-up" data-aos-duration="3000" variant="contained" style={{backgroundColor: '#FFCC00', marginTop: '20px', color: 'black'}}><TelegramIcon/> Ro'yhatdan o'tish</Button>
            </div>
            <div className="right">
